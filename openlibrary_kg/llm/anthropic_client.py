...
class AnthropicClient(LLMClient):
    ...
    def __init__(
        ...
        self.rate_limiter = rate_limiter or RateLimiter(rate=5, capacity=5)
    ...
    async def generate_batch(
        ...
        sem = asyncio.Semaphore(self.rate_limiter.capacity)
                ...
                for attempt in range(self.max_retries):
                    ...
                    try:
                        ...
                        if resp.status_code == 200:
                            ...
                            delay = 2 ** attempt
                            logger.warning(
                                "HTTP %d from Anthropic, retrying in %ds (attempt %d/%d)",
                        ...
                        logger.error("Anthropic API exception: %s", exc)
